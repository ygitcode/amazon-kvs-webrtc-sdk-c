...
#define NUMBER_OF_ALAW_FRAME_FILES               332
#define NUMBER_OF_MULAW_FRAME_FILES              332
...
#define SAMPLE_AUDIO_ALAW_FRAME_DURATION (40 * HUNDREDS_OF_NANOS_IN_A_MILLISECOND)
#define SAMPLE_AUDIO_MULAW_FRAME_DURATION (40 * HUNDREDS_OF_NANOS_IN_A_MILLISECOND)
